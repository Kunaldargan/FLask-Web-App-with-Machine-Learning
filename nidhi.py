# -*- coding: utf-8 -*-
"""
Created on Mon Apr 24 12:36:05 2017
...
x_std=np.delete(x_std,(17),0)
x_std=np.delete(x_std,(15),0)
y_std=np.delete(y_std,(15),0)
y_std=np.delete(y_std,(17),0)
...
mlp = MLPRegressor(solver='sgd',max_iter=150, shuffle=True, random_state=10,
                           activation='logistic')

k_range = list(range(55,150,5))
print(k_range)
param_grid = dict(hidden_layer_sizes=k_range)
print(param_grid)

grid = GridSearchCV(mlp, param_grid, cv=10, scoring='neg_mean_squared_error')
...
plt.xlabel('Value of hidden layer')
